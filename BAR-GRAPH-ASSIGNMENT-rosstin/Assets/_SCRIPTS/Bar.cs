...
namespace BarGraphAssignment
{
    ...
    /// This script should be attached to the Bar prefab which is referenced by the Graph.
    /// </summary>
    public class Bar : XRSimpleInteractable, IMoveable, IEquatable<Bar>, IComparable<Bar>
    {
        ...
        /// <summary>
        /// Move smoothly while in unselected state
        /// </summary>
        ...
        /// <summary>
        /// Enter the unselected state. This will also trigger you to move to your destination if one is set.
        /// </summary>
        ...
        /// Used by the graph to build the bar from its data
        /// </summary>
