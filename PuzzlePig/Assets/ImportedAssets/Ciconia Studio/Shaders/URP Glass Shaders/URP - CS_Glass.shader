Shader "Ciconia Studio/CS_Glass/URP/Glass"
{
	...
	{
		[Space(15)]
		[Header(Surface Options________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________)]
		[Space(15)]
		[Enum(Double Sided,0,Back,1,Front,2)] _Cull("Render Face", Float) = 2
		[Enum(Off,0,On,1)] _ZWrite("ZWrite", Float) = 1.0 
		
		[Space(30)][Header(Main Properties________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________)]
		[Space(15)][Header(Global Tiling Offset)][Space(10)] _TilingX( "Tiling X", Float ) = 1
		_TilingY( "Tiling Y", Float ) = 1
		[Space(10)] _OffsetX( "Offset X", Float ) = 0
		_OffsetY( "Offset Y", Float ) = 0
		
		[Space(30)][Header(Main Maps)][Space(10)] _Color( "Color", Color ) = ( 0, 0, 0, 0 )
		_MainTex( "Albedo -->(Mask A)", 2D ) = "white" {}
		...
		[Space(15)] _Fade( "Fade", Range( 0, 1 ) ) = 0.2
		...
		[Space(15)] _ColorDecal( "Color -->(Transparency A)", Color ) = ( 1, 1, 1, 1 )
		[Space(10)] _DetailAlbedoMap( "Decal Map -->(Mask A)", 2D ) = "black" {}
		_SaturationDecal( "Saturation", Float ) = 0
		[Space(20)] _MetallicDecal( "Metallic", Range( 0, 1 ) ) = 0
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 tex2DNode76 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, ( appendResult14_g26 + appendResult13_g26 ) );
				...
				float2 uv_DetailAlbedoMap = input.ase_texcoord7.xyz.xy * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
				...
				float4 tex2DNode181 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_DetailAlbedoMap, rotator400 );
				...
				float2 uv_BumpMap = input.ase_texcoord7.xyz.xy * _BumpMap_ST.xy + _BumpMap_ST.zw;
				float2 break26_g25 = uv_BumpMap;
				...
				float3 unpack2 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, ( appendResult14_g25 + appendResult13_g25 ) ), _BumpScale );
				unpack2.z = lerp( 1, unpack2.z, saturate(_BumpScale) );
				float3 tex2DNode2 = unpack2;
				float2 uv_DetailNormalMap = input.ase_texcoord7.xyz.xy * _DetailNormalMap_ST.xy + _DetailNormalMap_ST.zw;
				...
				float3 unpack194 = UnpackNormalScale( SAMPLE_TEXTURE2D( _DetailNormalMap, sampler_DetailNormalMap, rotator409 ), _BumpScaleDecal );
				...
				float2 uv_MetallicGlossMap = input.ase_texcoord7.xyz.xy * _MetallicGlossMap_ST.xy + _MetallicGlossMap_ST.zw;
				...
				float4 tex2DNode123 = SAMPLE_TEXTURE2D( _MetallicGlossMap, sampler_MainTex, ( appendResult14_g24 + appendResult13_g24 ) );
				...
				float2 uv_OcclusionMap = input.ase_texcoord7.xyz.xy * _OcclusionMap_ST.xy + _OcclusionMap_ST.zw;
				...
				float blendOpSrc136 = SAMPLE_TEXTURE2D( _OcclusionMap, sampler_MainTex, ( appendResult14_g23 + appendResult13_g23 ) ).r;
				float blendOpDest136 = ( 1.0 - _AoIntensity );
				float Occlusion140 = ( saturate( ( 1.0 - ( 1.0 - blendOpSrc136 ) * ( 1.0 - blendOpDest136 ) ) ));
				
				float fresnelNdotV163 = dot( NormalWS, ViewDirWS );
				...
				float3 worldRefl3 = reflect( -ViewDirWS, float3( dot( tanToWorld0, NormalmapXYZ170 ), dot( tanToWorld1, NormalmapXYZ170 ), dot( tanToWorld2, NormalmapXYZ170 ) ) );
				float4 texCUBENode6 = SAMPLE_TEXTURECUBE_LOD( _CubeMap, sampler_CubeMap, worldRefl3, _BlurReflection );
				...
				float4 fetchOpaqueVal381 = float4( SHADERGRAPH_SAMPLE_SCENE_COLOR( ( (ase_grabScreenPosNorm).xyzw + float4( (( ( Normal101 + mul( float4( normalizedWorldNormal , 0.0 ), UNITY_MATRIX_V ).xyz ) *  (-1.0 + ( _Refraction - 0.0 ) * ( 1.0 - -1.0 ) / ( 2.0 - 0.0 ) ) )).xyz , 0.0 ) ).xy.xy ), 1.0 );
				...
				float fresnelNdotV25 = dot( NormalWS, ViewDirWS );
				...
				float fresnelNdotV515 = dot( NormalWS, ViewDirWS );
				...
				float3 BaseColor = AlbedoAmbient117.rgb;
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float lerpResult513 = lerp( -3.0 , 0.0 , _GradientFade);
				float fresnelNdotV515 = dot( ase_normalWS, ase_viewDirWS );
				float fresnelNode515 = ( lerpResult513 + _PowerFalloffFade * pow( max( 1.0 - fresnelNdotV515 , 0.0001 ),  (( 1.0 + -( 1.0 - _Fade ) ) + ( 1.0 - 0.0 ) * ( ( 1.0 - _Fade ) - ( 1.0 + -( 1.0 - _Fade ) ) ) / ( 1.0 - 0.0 ) ) ) );
				float clampResult518 = clamp( (( _InvertFresnelFade )?( ( 1.0 - fresnelNode515 ) ):( fresnelNode515 )) , 0.0 , 1.0 );
				float2 uv_DetailAlbedoMap = input.ase_texcoord2.xy * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
				float cos400 = cos( radians( _Rotation ) );
				float sin400 = sin( radians( _Rotation ) );
				float2 rotator400 = mul( uv_DetailAlbedoMap - float2( 0.5,0.5 ) , float2x2( cos400 , -sin400 , sin400 , cos400 )) + float2( 0.5,0.5 );
				float4 tex2DNode181 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_DetailAlbedoMap, rotator400 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float3 desaturateVar211 = lerp( desaturateInitialColor211, desaturateDot211.xxx, -clampResult239 );
				float4 temp_output_303_0 = CalculateContrast(_Brightness,float4( desaturateVar211 , 0.0 ));
				float2 uv_DetailAlbedoMap = input.ase_texcoord3.xyz.xy * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
				float cos400 = cos( radians( _Rotation ) );
				float sin400 = sin( radians( _Rotation ) );
				float2 rotator400 = mul( uv_DetailAlbedoMap - float2( 0.5,0.5 ) , float2x2( cos400 , -sin400 , sin400 , cos400 )) + float2( 0.5,0.5 );
				float4 tex2DNode181 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_DetailAlbedoMap, rotator400 );
				...
				float fresnelNdotV163 = dot( ase_normalWS, ase_viewDirWS );
				float fresnelNode163 = ( -0.05 + 1.0 * pow( max( 1.0 - fresnelNdotV163 , 0.0001 ), _PowerFresnel ) );
				float4 clampResult468 = clamp( ( _ColorFresnel1 * fresnelNode163 ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 ifLocalVar470 = 0;
				if( 0.0 > _FresnelStrength )
				...
				ifLocalVar470 = clampResult468;
				float clampResult463 = clamp( _FresnelStrength , -1.0 , 75.0 );
				float2 uv_BumpMap = input.ase_texcoord3.xyz.xy * _BumpMap_ST.xy + _BumpMap_ST.zw;
				float2 break26_g25 = uv_BumpMap;
				float2 appendResult14_g25 = (float2(( break26_g25.x * GlobalTilingX281 ) , ( break26_g25.y * GlobalTilingY282 )));
				float2 appendResult13_g25 = (float2(( break26_g25.x + GlobalOffsetX541 ) , ( break26_g25.y + GlobalOffsetY540 )));
				float3 unpack2 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, ( appendResult14_g25 + appendResult13_g25 ) ), _BumpScale );
				...
				float3 worldRefl3 = reflect( -ase_viewDirWS, float3( dot( tanToWorld0, NormalmapXYZ170 ), dot( tanToWorld1, NormalmapXYZ170 ), dot( tanToWorld2, NormalmapXYZ170 ) ) );
				float4 texCUBENode6 = SAMPLE_TEXTURECUBE_LOD( _CubeMap, sampler_CubeMap, worldRefl3, _BlurReflection );
				float4 temp_cast_6 = (1.0).xxxx;
				#ifdef _USECUBEMAP_OFF
				float4 staticSwitch461 = temp_cast_6;
				...
				float4 ase_grabScreenPos = ASE_ComputeGrabScreenPos( screenPos );
				float4 ase_grabScreenPosNorm = ase_grabScreenPos / ase_grabScreenPos.w;
				float2 uv_DetailNormalMap = input.ase_texcoord3.xyz.xy * _DetailNormalMap_ST.xy + _DetailNormalMap_ST.zw;
				float Rotator_Detailsmaps411 = _Rotation;
				float cos409 = cos( radians( Rotator_Detailsmaps411 ) );
				float sin409 = sin( radians( Rotator_Detailsmaps411 ) );
				float2 rotator409 = mul( uv_DetailNormalMap - float2( 0.5,0.5 ) , float2x2( cos409 , -sin409 , sin409 , cos409 )) + float2( 0.5,0.5 );
				...
				float lerpResult483 = lerp( 0.0 , _Intensity , _Opacity);
				float lerpResult68 = lerp( -3.0 , 0.0 , _FalloffOpacityIntensity);
				float fresnelNdotV25 = dot( ase_normalWS, ase_viewDirWS );
				float fresnelNode25 = ( lerpResult68 + _PowerFalloffOpacity * pow( max( 1.0 - fresnelNdotV25 , 0.0001 ),  (( 1.0 + -lerpResult483 ) + ( 1.0 - 0.0 ) * ( lerpResult483 - ( 1.0 + -lerpResult483 ) ) / ( 1.0 - 0.0 ) ) ) );
				float clampResult45 = clamp( (( _Invert )?( ( 1.0 - fresnelNode25 ) ):( fresnelNode25 )) , 0.0 , 1.0 );
				float AlbedoA250 = tex2DNode76.a;
				float2 uv_MetallicGlossMap = input.ase_texcoord3.xyz.xy * _MetallicGlossMap_ST.xy + _MetallicGlossMap_ST.zw;
				float2 break26_g24 = uv_MetallicGlossMap;
				float2 appendResult14_g24 = (float2(( break26_g24.x * GlobalTilingX281 ) , ( break26_g24.y * GlobalTilingY282 )));
				float2 appendResult13_g24 = (float2(( break26_g24.x + GlobalOffsetX541 ) , ( break26_g24.y + GlobalOffsetY540 )));
				float4 tex2DNode123 = SAMPLE_TEXTURE2D( _MetallicGlossMap, sampler_MainTex, ( appendResult14_g24 + appendResult13_g24 ) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float3 desaturateVar211 = lerp( desaturateInitialColor211, desaturateDot211.xxx, -clampResult239 );
				float4 temp_output_303_0 = CalculateContrast(_Brightness,float4( desaturateVar211 , 0.0 ));
				float2 uv_DetailAlbedoMap = input.ase_texcoord1.xy * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
				float cos400 = cos( radians( _Rotation ) );
				float sin400 = sin( radians( _Rotation ) );
				float2 rotator400 = mul( uv_DetailAlbedoMap - float2( 0.5,0.5 ) , float2x2( cos400 , -sin400 , sin400 , cos400 )) + float2( 0.5,0.5 );
				float4 tex2DNode181 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_DetailAlbedoMap, rotator400 );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float3 tex2DNode194 = unpack194;
				float3 lerpResult308 = lerp( tex2DNode194 , BlendNormal( tex2DNode2 , tex2DNode194 ) , _BumpScaleDecal1);
				float2 uv_DetailAlbedoMap = input.ase_texcoord3.xy * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
				float cos400 = cos( radians( _Rotation ) );
				float sin400 = sin( radians( _Rotation ) );
				float2 rotator400 = mul( uv_DetailAlbedoMap - float2( 0.5,0.5 ) , float2x2( cos400 , -sin400 , sin400 , cos400 )) + float2( 0.5,0.5 );
				float4 tex2DNode181 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_DetailAlbedoMap, rotator400 );
				...
				float3 ase_viewDirWS = normalize( ase_viewVectorWS );
				float lerpResult513 = lerp( -3.0 , 0.0 , _GradientFade);
				float fresnelNdotV515 = dot( NormalWS, ase_viewDirWS );
				float fresnelNode515 = ( lerpResult513 + _PowerFalloffFade * pow( max( 1.0 - fresnelNdotV515 , 0.0001 ),  (( 1.0 + -( 1.0 - _Fade ) ) + ( 1.0 - 0.0 ) * ( ( 1.0 - _Fade ) - ( 1.0 + -( 1.0 - _Fade ) ) ) / ( 1.0 - 0.0 ) ) ) );
				float clampResult518 = clamp( (( _InvertFresnelFade )?( ( 1.0 - fresnelNode515 ) ):( fresnelNode515 )) , 0.0 , 1.0 );
				float lerpResult537 = lerp( (( _FalloffFade )?( clampResult518 ):( ( 1.0 - _Fade ) )) , 1.0 , DecalMask182);
				float Fade450 = (( _FalloffFade1 )?( lerpResult537 ):( (( _FalloffFade )?( clampResult518 ):( ( 1.0 - _Fade ) )) ));
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float fresnelNode515 = ( lerpResult513 + _PowerFalloffFade * pow( max( 1.0 - fresnelNdotV515 , 0.0001 ),  (( 1.0 + -( 1.0 - _Fade ) ) + ( 1.0 - 0.0 ) * ( ( 1.0 - _Fade ) - ( 1.0 + -( 1.0 - _Fade ) ) ) / ( 1.0 - 0.0 ) ) ) );
				float clampResult518 = clamp( (( _InvertFresnelFade )?( ( 1.0 - fresnelNode515 ) ):( fresnelNode515 )) , 0.0 , 1.0 );
				float2 uv_DetailAlbedoMap = input.ase_texcoord4.xy * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
				float cos400 = cos( radians( _Rotation ) );
				float sin400 = sin( radians( _Rotation ) );
				float2 rotator400 = mul( uv_DetailAlbedoMap - float2( 0.5,0.5 ) , float2x2( cos400 , -sin400 , sin400 , cos400 )) + float2( 0.5,0.5 );
				float4 tex2DNode181 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_DetailAlbedoMap, rotator400 );
