	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 tex2DNode76 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, ( appendResult14_g6 + appendResult13_g6 ) );
				...
				float3 unpack2 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, ( appendResult14_g13 + appendResult13_g13 ) ), _BumpScale );
				...
				float4 tex2DNode123 = SAMPLE_TEXTURE2D( _MetallicGlossMap, sampler_MainTex, ( appendResult14_g7 + appendResult13_g7 ) );
				...
				float blendOpSrc136 = SAMPLE_TEXTURE2D( _OcclusionMap, sampler_MainTex, ( appendResult14_g12 + appendResult13_g12 ) ).r;
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 tex2DNode76 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, ( appendResult14_g6 + appendResult13_g6 ) );
				float AlbedoA250 = tex2DNode76.a;
				float2 uv_MetallicGlossMap = input.ase_texcoord2.xy * _MetallicGlossMap_ST.xy + _MetallicGlossMap_ST.zw;
				float2 break26_g7 = uv_MetallicGlossMap;
				float2 appendResult14_g7 = (float2(( break26_g7.x * GlobalTilingX281 ) , ( break26_g7.y * GlobalTilingY282 )));
				float2 appendResult13_g7 = (float2(( break26_g7.x + GlobalOffsetX493 ) , ( break26_g7.y + GlobalOffsetY496 )));
				float4 tex2DNode123 = SAMPLE_TEXTURE2D( _MetallicGlossMap, sampler_MainTex, ( appendResult14_g7 + appendResult13_g7 ) );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float3 ase_viewDirWS = normalize( ase_viewVectorWS );
				float lerpResult68 = lerp( -3.0 , 0.0 , _FalloffOpacityIntensity);
				float fresnelNdotV25 = dot( NormalWS, ase_viewDirWS );
				float fresnelNode25 = ( lerpResult68 + _PowerFalloffOpacity * pow( max( 1.0 - fresnelNdotV25 , 0.0001 ),  (( 1.0 + -_Opacity ) + ( 1.0 - 0.0 ) * ( _Opacity - ( 1.0 + -_Opacity ) ) / ( 1.0 - 0.0 ) ) ) );
				float clampResult45 = clamp( (( _Invert )?( ( 1.0 - fresnelNode25 ) ):( fresnelNode25 )) , 0.0 , 1.0 );
