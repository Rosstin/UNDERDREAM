#ifndef AZTECHGAMES_WIREFRAME
#define AZTECHGAMES_WIREFRAME
...
// SHADER PROGRAMS //
// Vertex Shader
AZTECH_v2g AZTECH_vert(appdata_base v)
{
	AZTECH_v2g output;
...
// Geometry Shader
[maxvertexcount(3)]
void AZTECH_geom(triangle AZTECH_v2g p[3], inout TriangleStream<AZTECH_g2f> triStream)
{
...
// Fragment Shader
float4 AZTECH_frag(AZTECH_g2f input) : COLOR
{			
